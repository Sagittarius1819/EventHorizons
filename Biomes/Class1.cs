...
namespace EventHorizons.Biomes
{
    public class Class1 : ModBiome
	{
        ...
        public override ModUndergroundBackgroundStyle UndergroundBackgroundStyle => ModContent.GetInstance<CrystalBackgroundStyle>();

        // Select Music
        public override int Music => MusicLoader.GetMusicSlot(Mod, "Assets/Music/Let_It_Be_The_Crystal");
