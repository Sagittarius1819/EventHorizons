...
namespace EventHorizons.Content.Items.Weapons.Ranged
{
    public class Galaxy_Cannon : ModItem
    {
        public override void SetDefaults()
        {
            ...
            // Gun Properties
            Item.shoot = ProjectileType<Superwaves>(); // For some reason, all the guns in the vanilla source have this.
        ...
        {
            SoundStyle usesound = new("EventHorizons/Content/Assets/Sounds/GalacticBeep");
