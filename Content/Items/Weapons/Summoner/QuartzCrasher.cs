...
namespace EventHorizons.Content.Items.Weapons.Summoner
{
    internal class QuartzCrasher : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.DefaultToWhip(ProjectileType<QCwhipprojectile>(), 35, 2, 4);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int i = 0; i < list.Count - 1; i++)
            {
                ...
                if (i == list.Count - 2)
                {
                    ...
                    scale = Lerp(0.5f, 1.5f, Utils.GetLerpValue(0.1f, 0.7f, t, true) * Utils.GetLerpValue(0.9f, 0.7f, t, true));
                }
                else if (i > 10)
                {
                    // Third segment
